...
module Mailers
  class AuthMailer < Mailers::RootMailer
    def send_email_verification_email(user)
      ...
      content = SendGrid::Content.new(type: 'text/html',
                                      value: "Click here to confirm your email address: <a href=#{app_host}/verify-email?token=#{signed_id}>Confirm</a>")
    ...
    def send_password_reset_email
      user.password_reset_tokens.create.signed_id(expires_in: 20.minutes)
    end

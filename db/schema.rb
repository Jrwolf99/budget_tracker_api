...
ActiveRecord::Schema[7.0].define(version: 20_230_910_154_256) do
  ...
  create_table 'goals', force: :cascade do |t|
    ...
    t.index %w[month year spend_account_id], name: 'index_goals_on_month_and_year_and_spend_account_id',
                                             unique: true
